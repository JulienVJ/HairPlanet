...
func jsonResponse(w http.ResponseWriter, data []byte, err error) {
	if err != nil {
...
func allReservations(w http.ResponseWriter, r *http.Request) {
	// Call the GetAllReservations function to get JSON data
	jsonData, err := api.GetAllReservations()
	jsonResponse(w, jsonData, err)
}

func allUsers(w http.ResponseWriter, r *http.Request) {
	// Call the GetAllUsers function to get JSON data
